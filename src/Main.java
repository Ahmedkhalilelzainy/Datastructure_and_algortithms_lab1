...
//        usedTree.insert(6);
//        usedTree.insert(8);
//        System.out.println( usedTree.getSize() );
//        System.out.println( usedTree.getHeight() );
//        System.out.println( usedTree.insert( 10 ) );
//        System.out.println( usedTree.getSize() );
//        System.out.println( usedTree.getHeight() );
//
////        usedTree.delete(10);
...
//        usedTree1.treeTraversal( usedTree1.getRoot(), "root" );
        ...
        while (true){
            ...
            if(operation.equals("1")){
                ...
                System.out.println("Dictionary size is: " + dictionary.getSize());
            }else if(operation.equals("7")){
                int h = dictionary.getHeight();
                if( h == -1){
